...
INSERT INTO reservations (restaurant_id, table_id, first_name, last_name, phone, party_size, reservation_date)
VALUES (1, 1, 'Alice', 'Dupont', '0612345678', 2, TO_TIMESTAMP('2025-06-15 19:30:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO reservations (restaurant_id, table_id,first_name, last_name, phone, party_size, reservation_date, reservation_time)
VALUES (1, 2, 'Jean', 'Martin', '0623456789', 4,TO_TIMESTAMP('2025-06-15 19:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2025-06-15 19:30:00', 'YYYY-MM-DD HH24:MI:SS'));

-- Réservations pour Bistro des Arts
INSERT INTO reservations (restaurant_id, table_id,first_name, last_name, phone, party_size, reservation_date)
VALUES (2, 3, 'Claire', 'Durand', '0634567890', 3,TO_TIMESTAMP('2025-06-15 19:30:00', 'YYYY-MM-DD HH24:MI:SS'));

-- Réservations pour La Table Lorraine
INSERT INTO reservations (restaurant_id, table_id,first_name, last_name, phone, party_size, reservation_date, reservation_time)
VALUES (3, 4, 'Luc', 'Petit', '0645678901', 2, TO_TIMESTAMP('2025-06-15 19:30:00', 'YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2025-06-14 12:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO reservations (restaurant_id, table_id,first_name, last_name, phone, party_size, reservation_date)
VALUES (3, 5, 'Nora', 'Benoit', '0656789012', 5, TO_TIMESTAMP('2025-06-15 19:30:00', 'YYYY-MM-DD HH24:MI:SS'));
