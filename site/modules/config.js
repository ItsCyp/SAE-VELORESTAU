...
let WEATHER_API_URL = `https://api.openweathermap.org/data/2.5/weather?lat=${NANCY_LAT}&lon=${NANCY_LON}&appid=${WEATHER_API_KEY}&units=metric&lang=fr`;
...
const initConfig = async () => {
    // Si la configuration est déjà en cours de chargement, retourner la promesse existante
    if (configPromise) {
...
// Fonction pour attendre que la configuration soit prête
...
export default {
    ...
    reloadConfig,
    waitForConfig,
    get isConfigReady() { return isConfigReady; },
